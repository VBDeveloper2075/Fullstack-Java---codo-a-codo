...
// saludo.forEach(elemento => console.log(elemento.textContent));
...
// Vamos a centrarnos en el proceso de creación del elemento.Mas adelante veremos el apartado de insertarlo en el DOM. El funcionamiento de .createElement() es muy sencillo: se trata de pasarle el nombre de la etiqueta tag a utilizar.
